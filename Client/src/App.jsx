...
const SupplierLedger = lazy(() => import('./pages/branch-admin/SupplierLedger'));
...
// Promotions import removed — module disabled
  ...
  return (
    ...
    <Routes>
      ...
      />
        ...
        {/* Promotions routes disabled — redirect to home */}
        <Route path="/admin/promotions" element={<Navigate to="/" replace />} />
        <Route path="/branch-admin/promotions" element={<Navigate to="/" replace />} />
